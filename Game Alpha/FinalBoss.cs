public class FinalBoss : Monster
{
    ...
    public FinalBoss(int id, string name, string description, string mapIcon, int locationX, int locationY)
        : base(id, name, description, mapIcon, 100, 10, 20, locationX, locationY)
    {
        currentPhase = 1;
    ...
    public override int GenAttackDamage()
    {
